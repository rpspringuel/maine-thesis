...
\begin{itemize}
\item{{\bfseries Remove extra space between chapters in list of figures and tables.} This is implemented as an option, you can add the space back (for unofficial copies) with the loftspacing option.}
